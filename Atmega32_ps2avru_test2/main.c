...
uint8_t hexaKeys0[ROWS][COLS] = {
	...
	{0x00,0x00,0x00,KEY_B,KEY_N,0x00,KEY_FN,KEY_SLASH,KEY_RIGHT_ALT,KEY_FN},//ROW5
...
uint8_t hexaKeys1[ROWS][COLS] = {
	...
	{0x00,0x00,0x00,0x00,0x00,0x00,KEY_FN,0x00,KEY_RIGHT_ALT,KEY_FN},//ROW5
...
uint8_t keymask[ROWS][COLS]={
	...
	{0x00,0x00,0x00,0x10,0x10,0x00,0x66,0x00,0x22,0x66},//ROW5
